...
Raw Data Ingestion: New orders from transactional DB
Cleaning & Validation: Pandera schema checks, outlier flags
Feature Computation: RFM, CLV, churn features (~2 min)
Model Scoring: Churn + sales predictions on new customers (~30 sec)
Reporting: KPI aggregation, executive summary generation (~1 min)
Dashboard Update: Streamlit auto-reloads cached data
...
GitHub: github.com/shivamssingh07
